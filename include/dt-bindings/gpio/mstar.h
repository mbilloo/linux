...
#define MSC313_I2C1		MSC313_FUART_RTS
#define MSC313_I2C1_SCL		(MSC313_I2C1 + 0)
#define MSC313_I2C1_SDA		(MSC313_I2C1 + 1)

#define MSC313_SR		MSC313_I2C1_SDA
#define MSC313_SR_IO2		(MSC313_I2C1 + 0)
#define MSC313_SR_IO3		(MSC313_I2C1 + 1)
#define MSC313_SR_IO4		(MSC313_I2C1 + 2)
#define MSC313_SR_IO5		(MSC313_I2C1 + 3)
#define MSC313_SR_IO6		(MSC313_I2C1 + 4)
#define MSC313_SR_IO7		(MSC313_I2C1 + 5)
#define MSC313_SR_IO8		(MSC313_I2C1 + 6)
#define MSC313_SR_IO9		(MSC313_I2C1 + 7)
#define MSC313_SR_IO10		(MSC313_I2C1 + 8)
#define MSC313_SR_IO11		(MSC313_I2C1 + 9)
#define MSC313_SR_IO12		(MSC313_I2C1 + 10)
#define MSC313_SR_IO13		(MSC313_I2C1 + 11)
#define MSC313_SR_IO14		(MSC313_I2C1 + 12)
#define MSC313_SR_IO15		(MSC313_I2C1 + 13)
#define MSC313_SR_IO16		(MSC313_I2C1 + 14)
#define MSC313_SR_IO17		(MSC313_I2C1 + 15)
